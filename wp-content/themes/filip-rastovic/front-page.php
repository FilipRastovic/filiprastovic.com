  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-6 mx-auto col-md-4">
        <img data-aos="fade-left" class="img-fluid mt-5" src="<?php bloginfo('template_url'); ?>/assets/img/hero.png" alt="">
      </div>
    </div>
  </div>
</header>
...
<section class="grey-bordered" id="portfolio">
  <div class="container">
    ...
    <div  class="row">
      <div data-aos="fade-up"  class="col-md-6 portfolio-item text-center">
      ...
      <div data-aos="fade-up"  class="col-md-6 portfolio-item text-center">
        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal10">
          ...
          <img class="img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/portfolio/filiprastovic-small.png" alt="">
        </a>
        <div class="portfolio-caption">
          <h4>Freelancer Landing Page</h4>
          <p class="text-muted">Design &amp; Development</p>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <div class="modal-body">
              <!-- Project Details Go Here -->
              <h2 class="text-uppercase">Freelancer Landing Page</h2>
              <p class="item-intro text-muted">Design &amp; Development</p>
              <img class="img-fluid d-block mx-auto" src="<?php bloginfo('template_url'); ?>/assets/img/portfolio/filiprastovic-small.png"
                alt="">
              <p>I have designed and developed this general purpose freelancer landing page for up own web design business. It has as high conversion rate and pretty smooth design.</p>
              <ul class="list-inline">
                <li>Date: 2018</li>
                <li>Client: Myself</li>
                <li>Category: Design &amp; Development</li>
