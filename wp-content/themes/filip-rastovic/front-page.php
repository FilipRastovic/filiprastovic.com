  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7 mx-auto">
        ...
        <hr class="">
        <p>I'm Filip, a <strong>freelance designer</strong> with an affection for web, user experience and product design.  I work with companies around the globe helping them build beautiful and functional software with a focus on conversions, UX, responsive design, performance & accessibility. I build, manage & implement design systems, animations & interactions. My hobbies are <a href="/blog">writing</a> , <a href="https://github.com/FilipRastovic" target="_blank">coding</a> and making <a href="http://stargazerstudio.net" target="_blank">video games</a>. See my portfolio or check out my <a href="<?php bloginfo('template_url'); ?>/assets/download/Filip_Rastovic_Resume.pdf" target="_blank">resume</a>.</p>
      </div>
    </div>
  </div>
</header>
