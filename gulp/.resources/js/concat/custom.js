jQuery(document).ready(function($){window.addEventListener("load", windowLoadHandler, false);
...
function canvasApp() {
	...
	function setCircles() {
		...
		for (i = 0; i < numCircles; i++) {
			...
			grad.addColorStop(1,"rgba(255,193,7, 0.04)");
			grad.addColorStop(0,"rgba(255,193,7, 0.04)"); 
