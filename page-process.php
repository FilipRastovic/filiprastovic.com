	...
	<div class="container">
		<div class="row justify-content-center mb-5">
			...
			<div class="col-lg-10 align-self-end text-center">
				<h2 class="text-uppercase font-weight-bold mb-3">Web design process</h2>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				...
				<a target="_BLANK" href="https://customr.app/" class="btn btn-outline-primary btn-sm mb-5 ">Visit Page</a>
		...
		<div class="row justify-content-center animatedParent animateOnce">
			...
			<div class="col-lg-4 mb-5 wow animated fadeIn" data-wow-duration="3s" data-wow-delay=".5s">
				<div class="circle-icon">
					...
					<div class="text">
						<h6 class="text-uppercase text-primary mb-2">Split Testing</h6>
						<p class="font-weight-light text-muted">Testing landing pages is the best experiment you can do. Testing allows you to learn more about your audience.</p>
					</div>
				</div>
			...
			<div class="col-lg-12 mb-3 text-center wow animated fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
				<a href="#contact" class="btn btn-primary btn-xl shadow js-scroll-trigger"><i class="fas fa-info-circle"></i>GET IN TOUCH</a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/molnar.jpeg" alt="Testimonial Person Image" class="testimonial-img">
			...
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/Maria.jpg" alt="Testimonial Person Image" class="testimonial-img">
				<p class="font-weight-light text-muted testimonial-paragraph text-left mb-4">
			...
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/liam.jpg" alt="Testimonial Person Image" class="testimonial-img">
				<p class="font-weight-light text-muted testimonial-paragraph text-left mb-4">
		...
		<div class="row">
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/andrew.jpg" alt="Testimonial Person Image" class="testimonial-img">
				<p class="font-weight-light text-muted testimonial-paragraph text-left mb-4">
			...
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/battista.jpg" alt="Testimonial Person Image" class="testimonial-img">
				<p class="font-weight-light text-muted testimonial-paragraph text-left mb-4">
			...
			<div class="col-lg-4 mb-5 wow fadeIn animated" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn;">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/testimonials/gari-designer.jpg" alt="Testimonial Person Image" class="testimonial-img">
				<p class="font-weight-light text-muted testimonial-paragraph text-left mb-4">
